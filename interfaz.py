...
#############################################   Generar Respuesta #########################################################################
    ...
    def generar_respuesta(self):
        ...
        response = openai.Completion.create(
            ...
            prompt=prompt,
            temperature=1,
            max_tokens=70,#tamaño de la respuesta a generar
            top_p=1,
            frequency_penalty=0,
            presence_penalty=0
        )
    ...
    def initUI(self):     
        ...
        self.Trancripcion.setGeometry(QtCore.QRect(130, 30, 511, 121))
        self.Trancripcion.setText("Transcripcion")

        self.Respesta = QtWidgets.QLabel(self)
        self.Respesta.setGeometry(QtCore.QRect(70, 330, 650, 200))
        ...
        self.Trancripcion.setAlignment(QtCore.Qt.AlignCenter)
        self.Respesta.setAlignment(QtCore.Qt.AlignCenter)
        #Acciones de Botones
